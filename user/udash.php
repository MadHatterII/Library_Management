...
<nav>
    ...
    <div class="dashboard-buttons">
        ...
        <div class="button-layer">
            <button class="availbooks" onclick="location.href='uavailbooks.php'">AVAILABLE BOOKS</button>

            <button class="borrowedbooks" onclick="location.href='uviewborrowed.php'">BORROWED BOOKS</button>
     
        </div>

        <!-- Second layer of buttons -->
        <div class="button-layer">
            <button class="viewstudents" onclick="location.href='user-dashboard.php'">VIEW PROFILE</button>
            <button onclick="location.href='admin-dashboard.php'">PENDING REQUEST</button>
            <button onclick="location.href='user-dashboard.php'"></button>
